class SelfiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @selfy.save
        format.html { redirect_to selfy_url(@selfy), notice: "Selfie was successfully created." }
  ...
  def update
    respond_to do |format|
      if @selfy.update(selfy_params)
        format.html { redirect_to selfy_url(@selfy), notice: "Selfie was successfully updated." }
  ...
  private
    ...
    def selfy_params
      params.require(:selfy).permit(:title)
    end
end
